      ...
      >
        <div className="max-w-screen-xl mx-auto px-5 py-5">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <a
                ...
                className="border border-[#ffffff10] bg-white hover:bg-white/10 text-black hover:text-white backdrop-blur-xl py-2 px-6 rounded-lg font-medium inline-block transition-all duration-300"
              >
                Launch App
              </a>
            </motion.nav>
          ...
          <div className="relative text-white overflow-hidden ">
            <div className="relative container max-w-screen-xl mx-auto px-5 pt-16 pb-10 md:pb-20">
                ...
                >
                  <div className="space-y-6 z-10 text-center md:text-left">
                    ...
                    <p className="text-white text-lg opacity-70">
                      Trust layer that powers reputation-based applications
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="relative flex gap-4">
                  ...
                  <div>
                    <h4 className="text-2xl md:text-3xl lg:text-[2.5rem] font-medium text-white font-geistMono mb-2">
                      820M
                    </h4>
        ...
        <section className="px-5 py-10 md:py-20 max-w-screen-xl mx-auto">
          <div className="flex flex-wrap justify-between items-start gap-2">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              <button className="bg-[#0CFF85] hover:bg-[#0CFF85]/80 text-black font-semibold px-8 py-3 mt-3 md:mt-0 rounded-lg transition-all duration-300 transform hover:scale-105">
                Register Your ID
              </button>
            </motion.div>
          </div>
          ...
          <div className="px-5 max-w-screen-xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
              ...
              >
                  ...
                  <button className="bg-[#0CFF85] hover:bg-[#0CFF85]/80 text-black font-semibold px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 mt-4 md:mt-14">
                    Build with ZKScore
                  </button>
              </motion.div>
              </div>
